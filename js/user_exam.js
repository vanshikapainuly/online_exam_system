...
$(document).ready(function(){
    $('#submitPaperButton').click(function(){
        if(confirm("Are you sure you want to submit the paper?")) {
            var exam_id = $('#processExamId').data('exam_id');

            $.ajax({
                url: "user_exam_action.php",
                method: "POST",
                data: {action: 'submitExam', exam_id: exam_id},
                dataType: "json",
